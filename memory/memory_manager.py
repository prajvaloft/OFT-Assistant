...
def should_extract_memory(user_text: str, oft_text: str, api_key: str = "") -> bool:
    try:
...
def extract_memory(user_text: str, oft_text: str, api_key: str = "") -> dict:
    try:
        from or_client import client
        ...
        raw = client.chat(
            ...
            f"                  (e.g. prajval: 'Building a oft-like AI assistant')\n"
            ...
            f"- Extract from BOTH user and oft turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"oft-like AI assistant"}}}},\n'
